...
(function () {
  ...
  function buildFooter() {
    ...
    el.innerHTML =
      '<div class="in"><a class="brand" href="index.html"><img src="assets/aj-logo.svg" alt="Al Jazeera"></a>' + cols + '</div>' +
  ...
  function apply() {
    ...
    if (!document.getElementById('aj-hp')) {
      ...
      if (!document.getElementById('aj-ask-loaded')) { var sc = document.createElement('script'); sc.id = 'aj-ask-loaded'; sc.src = 'js/aj-ask.js?v=14'; document.body.appendChild(sc); }
    }
