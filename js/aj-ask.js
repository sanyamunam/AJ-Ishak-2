...
(function () {
  ...
  var CSS = [
    ...
    /* the orb itself is the shared .aura-orb component (css/aj-aura-orb.css) */
    ...
    '.aj-say{padding:11px 14px;font-size:13.5px;line-height:1.55;margin:0 0 16px}',
    '.aj-lead{font-size:13.5px;margin:0 0 12px}',
    '.aj-status{font-size:12px;margin:0 0 10px}',
    '.aj-status b{font-size:11px}',
    '.aj-src{gap:10px;margin:0 0 10px}',
    '.aj-src-lbl{font-size:10.5px}',
    '.aj-src-rule{width:32px}',
    '.aj-src-chip{font-size:12px;padding:6px 10px 6px 6px}',
    '.aj-live{margin:0 0 16px}',
    '.aj-live-media{width:110px;min-height:100px}',
    '.aj-live-txt{padding:10px 14px;gap:6px}',
    '.aj-live-txt h4{font-size:14.5px}',
    '.aj-live-body{font-size:12px}',
    '.aj-live-meta{font-size:11.5px}',
    '.aj-nums{padding:2px 14px}',
    '.aj-num{padding:12px 0;gap:10px}',
    '.aj-num h6{font-size:13px}',
    '.aj-card{padding:11px 14px}',
    '.aj-card h5{font-size:13px}',
    '.aj-cta{font-size:12.5px}',
    '.aj-when{font-size:11.5px}',
    '.aj-flag{font-size:13px;padding:10px 13px;gap:8px}',
    '.aj-flag span{font-size:19px}',
    ...
    function buildBlock(b) {
      ...
      if (b.kind === 'live') {
        ...
        return el('aj-live aj-in',
          '<div class="aj-live-media"><img src="assets/aj-live-thumb.jpg" alt=""><span class="aj-live-badge">LIVE</span>' +
