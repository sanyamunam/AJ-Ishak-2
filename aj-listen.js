  ...
  function build() {
    ...
    player.innerHTML =
      '<div class="ajl-bg ajl-bg--player"><div class="ajl-main">' +
        '<div class="ajl-left">' +
          '<div class="ajl-lead">' +
            '<img class="ajl-thumb" src="aj-listen-thumb.jpg" alt="">' +
            '<div class="ajl-info">' +
            ...
            '</div>' +
          '</div>' +
          '<img class="ajl-controls" src="aj-listen-controls.svg" alt="Playback controls">' +
        '</div>' +
        '<div class="ajl-art"><div class="ring"><img src="aj-listen-art.png" alt=""><img src="aj-listen-art2.png" alt=""></div></div>' +
